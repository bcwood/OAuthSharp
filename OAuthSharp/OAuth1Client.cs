...
namespace OAuthSharp
{
    public class OAuth1Client
    {
        ...
        /// <param name="accessRequest">OAuthRequestTokenRequest instance.</param>
        /// <returns>
        ///   An OAuth1Response instance that contains the entire text of the response,
        ///   as well as any additional extracted parameters.
        /// </returns>
        public OAuth1Response AcquireRequestToken(string oauthTokenRequestUrl, OAuthRequestTokenRequest tokenRequest)
        {
        ...
        ///   as well as any additional extracted parameters.
        /// </returns>
        public OAuth1Response AcquireAccessToken(string oauthAccessTokenUrl, OAuthAccessTokenRequest accessRequest)
        {
        ...
        private string GetAuthorizationHeader(string url, OAuthRequest oauthRequest, string realm = null)
        {
