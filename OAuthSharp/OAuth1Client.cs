...
namespace OAuthSharp
{
    ...
    public class OAuth1Client
    {
        ...
        public OAuth1Client()
        {
            ...
            _params["signature_method"] = "PLAINTEXT";
            _params["signature"] = "";
            _params["token"] = "";
        ...
        ///   </para>
        /// </remarks>
        public OAuth1Client(string consumerKey,
        ...
        /// </returns>
        public OAuth1Response AcquireRequestToken(string uri, string method)
        {
            //NewRequest();
            ...
            using (var response = (System.Net.HttpWebResponse)request.GetResponse())
            {
                ...
                {
                    var OAuth1Response = new OAuth1Response(reader.ReadToEnd());
                    this["token"] = OAuth1Response["oauth_token"];
                    ...
                    try
                    {
                        if (OAuth1Response["oauth_token_secret"] != null)
                            this["token_secret"] = OAuth1Response["oauth_token_secret"];
                    }
                    catch { }
        ...
        public string GetAuthorizeTokenRedirectUrl(string oauthAuthorizeTokenUrl, string applicationName = null)
        {
            var sb = new StringBuilder();
            sb.AppendFormat("{0}?oauth_token={1}", oauthAuthorizeTokenUrl, this["token"]);
        ...
        ///   poauth_token=foo&something_else=bar.
        /// </returns>
        public OAuth1Response AcquireAccessToken(string uri, string method, string token, string tokenSecret, string verifier)
        {
            //NewRequest();
            _params["token"] = token;
            _params["token_secret"] = tokenSecret;
